...
export default function App() {
    return _jsx(BrowserRouter, { children: _jsx(AppProvider, { children: _jsx(ThemeHost, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(PublicRoute, { section: "overview" }) }), ["dues", "expenses", "payments", "balances", "history", "analytics", "reports"].map(x => _jsx(Route, { path: `/${x}`, element: _jsx(PublicRoute, { section: x }) }, x)), _jsx(Route, { path: "/admin/login", element: _jsx(LoginRoute, {}) }), ["overview", "expenses", "payments", "residents", "flats", "charges", "categories", "recurring", "reports", "activity", "settings"].map(x => _jsx(Route, { path: `/admin/${x}`, element: _jsx(AdminRoute, { section: x }) }, x)), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }) }) });
}
